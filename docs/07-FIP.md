...
**文档版本**：v1.1（2026-07-09 评分融合：移除教师端评价标准/标准库页面，任务弹窗集成评分细则 R/S/R 输入组件 GradingRuleForm）
...
| 教师 | 9 | Dashboard / 课程管理 / 任务管理（含评分细则 R/S/R 输入）/ 提交审核 / AI 预览 / 评分工作台 / 班级报表 / 学院报表 / 学生管理 |
